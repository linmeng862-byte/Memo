import { scanAllSkills, findSkill } from '../claude/skill-scanner.js';
...
export function handleHelp(_args) {
...
export function handleCwd(ctx, args) {
    if (!args) {
...
export function handleModel(ctx, args) {
    if (!args) {
...
export function handleSkills(args) {
...
export function handleHistory(ctx, args) {
...
/** 撤销最近 N 条对话 */
export function handleUndo(ctx, args) {
...
export function handlePrompt(_ctx, args) {
...
export function handleSend(ctx, args) {
    if (!args) {
...
export function handleUnknown(cmd, args) {
    const skills = getSkills();
